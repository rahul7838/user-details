...
class UserListAdapter(val context: Context) : PagedListAdapter<Result, RecyclerView.ViewHolder>(diff) {
    var networkState: NetworkState = NetworkState(Status.RUNNING)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            R.layout.progress_bar -> UserListAdapter(context).NetworkStatusViewHolder(networkInflater)
            R.layout.list_item -> UserListAdapter(context).UserListViewHolder(layoutInflater.inflate(R.layout.list_item, parent, false))
